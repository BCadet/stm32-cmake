...
IF(NOT FREERTOS_CMSIS_VER)
	MESSAGE(FATAL_ERROR "FREERTOS_CMSIS_VER not defined. Define it select proper CMSIS version for FreeRTOS.")
ELSE()
	SET(CMSIS_OS_SRC_FILE cmsis_os${FREERTOS_CMSIS_VER}.c)
	SET(CMSIS_OS_INC_FILE cmsis_os${FREERTOS_CMSIS_VER}.h cmsis_os.h)
ENDIF()
