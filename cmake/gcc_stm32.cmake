...
FUNCTION(STM32_PARSE_LINKER_SCRIPT TARGET)
    ...
    ELSE()
        file(STRINGS ${STM32_LINKER_SCRIPT} LS REGEX "ORIGIN = 0x[0-9]*,")
        list(GET LS 1 FLASH_STR)
        list(GET LS 0 RAM_STR)
        string(REGEX MATCH "0x[0-9]*" FLASH_ORIGIN ${FLASH_STR})
        string(REGEX MATCH "0x[0-9]*" RAM_ORIGIN ${RAM_STR})
        string(REGEX MATCH "[0-9]*K" FLASH_SIZE ${FLASH_STR})
        string(REGEX MATCH "[0-9]*K" RAM_SIZE ${RAM_STR})
