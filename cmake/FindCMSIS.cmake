...
ELSEIF(STM32_FAMILY STREQUAL "L4")
    ...
    IF(NOT CUSTOM_SYSTEM_SRC)
        SET(CMSIS_DEVICE_SOURCES system_stm32l4xx.c)
    ENDIF()
    IF(NOT CUSTOM_STARTUP_SRC)
        SET(CMSIS_STARTUP_SOURCE startup_stm32l${STM32_CHIP_TYPE_LOWER}.s)
    ENDIF()   
ENDIF()
...
IF(NOT CUSTOM_SYSTEM_SRC)
    MESSAGE(STATUS "add default system file from template")
    ...
    ENDFOREACH()
ELSE()
    LIST(APPEND CMSIS_SOURCES ${CUSTOM_SYSTEM_SRC})
ENDIF()

IF(NOT CUSTOM_STARTUP_SRC)
    MESSAGE(STATUS "add default startup file from template")
    IF(STM32_CHIP_TYPE)
    ...
    ENDIF()
ELSE()
    LIST(APPEND CMSIS_SOURCES ${CUSTOM_STARTUP_SRC})
ENDIF()
...
message(status "cmsys_sources=${CMSIS_SOURCES}")
